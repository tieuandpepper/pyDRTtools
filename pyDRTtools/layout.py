...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Central widget (plot area + panel)
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(400, 0, 1200, 1200))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        # Plot area
        self.plot_panel = QtWidgets.QGraphicsView(self.frame)
        self.plot_panel.setGeometry(QtCore.QRect(0, 50, 1060, 1060))
        self.plot_panel.setObjectName("plot_panel")
        self.show_layout = QtWidgets.QFrame(self.frame)
        # plot panel
        self.show_layout.setGeometry(QtCore.QRect(0, 0, 1060, 45))
        ...
        # height: 35
        # length: depend
        # space between buttons: 10
        # top margin: 10
        # left indent: 0
        # formula for next button left indent: previous_button_left_indent + previous_button_width + space_between_buttons
        self.show_EIS = QtWidgets.QPushButton(self.show_layout)
        self.show_EIS.setGeometry(QtCore.QRect(0, 10, 100, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_mag.setGeometry(QtCore.QRect(110, 10, 120, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_phase.setGeometry(QtCore.QRect(240, 10, 80, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_re.setGeometry(QtCore.QRect(330, 10, 90, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_im.setGeometry(QtCore.QRect(430, 10, 90, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_re_res.setGeometry(QtCore.QRect(530, 10, 120, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_im_res.setGeometry(QtCore.QRect(660, 10, 120, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_DRT.setGeometry(QtCore.QRect(790, 10, 60, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.show_score.setGeometry(QtCore.QRect(860, 10, 100, 35))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        # settings, options, control frame (General)
        self.General_frame = QtWidgets.QFrame(self.centralwidget)
        self.General_frame.setGeometry(QtCore.QRect(10, 10, 350, 1200))
        ...
        # Button: left indent: 90
        # Title: left indent: 10
        # Height: 30
        # Button width: depend on title (< 300)
        # Top indent: prev_top_indent + button_height + space_between_buttons
        # space_between_buttons = 10
        self.settings_layout = QtWidgets.QGroupBox(self.General_frame)
        self.settings_layout.setGeometry(QtCore.QRect(10, 0, 320, 550))
        font = QtGui.QFont()
...
"}")
        ...
        self.import_label.setGeometry(QtCore.QRect(10, 20, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.import_button.setGeometry(QtCore.QRect(90, 50, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.import_button.setFont(font)
        self.import_button.setObjectName("import_button")
        ### Yao Lab modification: import folder
        self.import_folder = QtWidgets.QPushButton(self.settings_layout)
        self.import_folder.setGeometry(QtCore.QRect(90, 80, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.discre_label.setGeometry(QtCore.QRect(10, 110, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.discre_choice.setGeometry(QtCore.QRect(90, 140, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.data_used_label.setGeometry(QtCore.QRect(10, 170, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.data_used_choice.setGeometry(QtCore.QRect(90, 200, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.induct_label.setGeometry(QtCore.QRect(10, 230, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.induct_choice.setGeometry(QtCore.QRect(90, 260, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.der_label.setGeometry(QtCore.QRect(10, 290, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.der_choice.setGeometry(QtCore.QRect(90, 320, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.lambda_choice_label.setGeometry(QtCore.QRect(10, 360, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lambda_choice.setGeometry(QtCore.QRect(90, 390, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.sample_no.setGeometry(QtCore.QRect(10, 420, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.sample_no_entry.setGeometry(QtCore.QRect(90, 450, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.reg_param_label.setGeometry(QtCore.QRect(10, 480, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.run_frame.setGeometry(QtCore.QRect(-10, 180, 320, 320))
        self.run_frame.setObjectName("run_frame")
        self.shape_control_label = QtWidgets.QLabel(self.RBF_frame)
        self.shape_control_label.setGeometry(QtCore.QRect(10, 30, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.shape_control_choice.setGeometry(QtCore.QRect(90, 60, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.FWHM_control_label.setGeometry(QtCore.QRect(10, 90, 290, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.FWHM_entry.setGeometry(QtCore.QRect(90, 120, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.run_layout.setGeometry(QtCore.QRect(10, 730, 320, 120))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
...
"}")
        ...
        self.simple_run_label.setGeometry(QtCore.QRect(10, 30, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.simple_run_button.setGeometry(QtCore.QRect(190, 30, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.bayes_label.setGeometry(QtCore.QRect(10, 60, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.bayesian_button.setGeometry(QtCore.QRect(190, 60, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.HT_label.setGeometry(QtCore.QRect(10, 90, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.HT_button.setGeometry(QtCore.QRect(190, 90, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.Peak_analysis_frame.setGeometry(QtCore.QRect(10, 860, 320, 120))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
...
"}")
        ...
        self.run_frame_2.setGeometry(QtCore.QRect(-10, 120, 320, 320))
        self.run_frame_2.setObjectName("run_frame_2")
        self.Peak_decon_run = QtWidgets.QLabel(self.Peak_analysis_frame)
        self.Peak_decon_run.setGeometry(QtCore.QRect(10, 90, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.peak_decon_button.setGeometry(QtCore.QRect(190, 90, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.reg_param_2.setGeometry(QtCore.QRect(10, 60, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.peak_num_entry.setGeometry(QtCore.QRect(190, 60, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.peak_method_label.setGeometry(QtCore.QRect(10, 30, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.peak_method_choice.setGeometry(QtCore.QRect(190, 30, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.export_frame.setGeometry(QtCore.QRect(10, 990, 320, 120))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
...
"}")
        ...
        self.export_DRT_label.setGeometry(QtCore.QRect(10, 30, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.export_EIS_label.setGeometry(QtCore.QRect(10, 60, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.export_fig_label.setGeometry(QtCore.QRect(10, 90, 170, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.export_DRT_button.setGeometry(QtCore.QRect(190, 30, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.export_EIS_button.setGeometry(QtCore.QRect(190, 60, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.export_fig_button.setGeometry(QtCore.QRect(190, 90, 100, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "pyDRTtools for Yao Group, developed by Francesco Ciucci"))
        ...
        self.import_button.setText(_translate("MainWindow", "File"))
        ### Yao Lab modification
        self.import_folder.setText(_translate("MainWindow", "Folder"))
        ###
